...
export default function LoadingTeamCard() {
	return (
		<BaseTeamCard
			title={<LoadingSkeleton className='w-72 h-6 bg-gray-500 mt-2' />}
			avatar={<LoadingSkeleton className='w-48 h-48 rounded bg-gradient-to-br from-gray-500 to-gray-700' bar={false} />}
