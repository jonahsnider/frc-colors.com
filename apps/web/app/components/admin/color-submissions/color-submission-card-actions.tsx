...
export function TableRowActions({ onApprove, onReject, status }: Props) {
	...
	if (status === 'error') {
		return (
			<div className='bg-red-400 text-neutral-900 rounded w-full flex items-center justify-center p-2 pt-1'>
	...
	if (status === 'success') {
		return (
			<div className='bg-neutral-700 text-green-400 rounded w-full flex items-center justify-center p-2 pt-1'>
	...
	return (
		<div className='bg-neutral-700 rounded w-full flex items-center justify-center p-2 pt-1'>
